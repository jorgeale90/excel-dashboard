<template>
  <div
    class="relative border-2 border-dashed border-surface-border rounded-2xl p-12 flex flex-col items-center gap-5 transition-all duration-200 cursor-pointer"
  ...
  >
    <!-- Icon -->
    <div class="w-16 h-16 rounded-2xl bg-surface-hover border border-surface-border flex items-center justify-center transition-transform duration-200"
         :class="{ 'scale-110 border-accent-blue/50': isDragging }">
      <svg class="w-8 h-8 text-gray-500 transition-colors duration-200" :class="{ '!text-accent-blue': isDragging }"
    ...
    <div class="text-center">
      ...
      <p class="text-sm text-gray-500 mt-1 font-body">Arrastra un .xlsx o haz click para seleccionar</p>
    </div>
